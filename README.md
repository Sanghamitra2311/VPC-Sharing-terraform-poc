...
# ==========================================
# Master toggle: Set to false to disable PSA entirely, bypassing the map below.
create_psa = true 

# Map of distinct IP ranges for Google Managed Services
psa_ranges = {
  "sample-range1" = {
  ...
  "sample-range2" = {
    address       = ""           # Left blank; GCP will auto-allocate a range
    prefix_length = 24
